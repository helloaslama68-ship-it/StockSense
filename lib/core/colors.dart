...
/// APP COLORS
/// Centralized color file used throughout the application.
/// Helps maintain consistent UI design.
...
class AppColors {
  ...
  static const Color goldDark = Color(0xFF8B5E00);
  ...
  static const Color backgroundTop = Color(0xFFF7F3EC);
  ...
  static const Color darkGrey2 = Color(0xFF3C3C3C);
  ...
  static const Color warmSurface = Color(0xFFE0DDD8);
  static const Color warmWhite = Color(0xFFF0EDE8);
  static const Color warmOrange = Color(0xFFFAEEDA);
  static const Color creamBg = Color(0xFFF1EFE8);
  static const Color creamWhite = Color(0xFFFDF6EC);
  ...
  static const Color darkRed2 = Color(0xFFA32D2D);
  static const Color lightRed = Color(0xFFFCEBEB);
  static const Color redAccent = Color(0xFFE04545);

  
  // GREEN COLORS
  

  static const Color darkGreen = Color(0xFF119C1A);
  ...
  static const Color darkBlue2 = Color(0xFF185FA5);
  static const Color lightBlue2 = Color(0xFFE6F1FB);
  static const Color paleBlue = Color(0xFFEAF0FF);
  static const Color royalBlue = Color(0xFF3B5BDB);
  ...
  // Dark Mode
  static const Color darkNotificationRed = Color(0xFF2D1F1F);
  static const Color darkGold = Color(0xFF332B12);
  static const Color darkOrange = Color(0xFF3A2418);
  static const Color darkBlue = Color(0xFF1B263B);
  static const Color darkPurple = Color(0xFF2C2340);
  ...
  static const Color surfaceDark2 = Color(0xFF3A3A3A);
  static const Color dividerDark = Color(0xFF2C2C2C);
  static const Color deepBrownBlack = Color(0xFF1E1A0D);
  static const Color warmDarkBrown = Color(0xFF2A1F0A);
}